var request = require("request"),
	...
	urls = [],
    sitios = ['http://www.elpais.com.uy/', 'http://ladiaria.com.uy/'];
    ...
    if(true)
    {
        ...
        //"a[id]" - Selecciona todos los link que contengan el atributo id.
        //"a[href]" - Selecciona todos los link que contengan el atributo ref.
        ...
        $("div a").each(function(){
            ...
            //var $a = link.children('a'); //('a:first-child');
            //var href = $a.attr('href');
            //var parent = link.parent('div');//Sirve para elpais.html
            //var hijo = link.find('a.first'); //Sirve para ?????
            //var idParent = contenedor.attr('id');
